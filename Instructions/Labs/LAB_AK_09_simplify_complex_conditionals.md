...
1. Set the chat mode to **Ask** and select the **Auto** model.
    ...
    The Set Mode and Pick Model menus are in the bottom-left corner of the Chat view. GitHub Copilot's **Ask** mode is used to ask general coding questions and to generate code related explanations. 
...
1. Ensure you have the GitHub Copilot Chat view open with **Ask** mode and the **Auto** model selected.
